...
export const SUPPORTED_LANGUAGES: LanguageDef[] = [
  ...
  { code: "el", label: "Greek", short: "EL" },
  { code: "he", label: "Hebrew", short: "HE", rtl: true },
  { code: "sv", label: "Swahili", short: "SW" },
  { code: "am", label: "Amharic", short: "AM" },
  { code: "hy", label: "Armenian", short: "HY" },
  { code: "ka", label: "Georgian", short: "KA" },
  { code: "az", label: "Azerbaijani", short: "AZ" },
  { code: "kk", label: "Kazakh", short: "KK" },
  { code: "uz", label: "Uzbek", short: "UZ" },
  { code: "tg", label: "Tajik", short: "TG" },
  { code: "ky", label: "Kyrgyz", short: "KY" },
  { code: "mn", label: "Mongolian", short: "MN" },
  { code: "lo", label: "Lao", short: "LO" },
  { code: "km", label: "Khmer", short: "KM" },
  { code: "my", label: "Burmese", short: "MY" },
  { code: "si", label: "Sinhala", short: "SI" },
  { code: "ne", label: "Nepali", short: "NE" },
  { code: "dz", label: "Dzongkha", short: "DZ" },
  { code: "bo", label: "Tibetan", short: "BO" },
  { code: "ti", label: "Tigrinya", short: "TI" },
  { code: "om", label: "Oromo", short: "OM" },
  { code: "so", label: "Somali", short: "SO" },
  { code: "sw", label: "Swahili", short: "SW" },
  { code: "zu", label: "Zulu", short: "ZU" },
  { code: "xh", label: "Xhosa", short: "XH" },
  { code: "st", label: "Sesotho", short: "ST" },
  { code: "tn", label: "Tswana", short: "TN" },
  { code: "ts", label: "Tsonga", short: "TS" },
  { code: "ss", label: "Swati", short: "SS" },
  { code: "ny", label: "Chichewa", short: "NY" },
  { code: "rw", label: "Kinyarwanda", short: "RW" },
  { code: "lg", label: "Ganda", short: "LG" },
  { code: "ha", label: "Hausa", short: "HA" },
  { code: "yo", label: "Yoruba", short: "YO" },
  { code: "ig", label: "Igbo", short: "IG" },
  { code: "ff", label: "Fula", short: "FF" },
  { code: "sd", label: "Sindhi", short: "SD" },
  { code: "ps", label: "Pashto", short: "PS", rtl: true },
  { code: "ku", label: "Kurdish (Kurmanji)", short: "KU" },
];
